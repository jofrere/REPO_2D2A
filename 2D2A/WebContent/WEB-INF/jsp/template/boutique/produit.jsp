				...
				<div id="content">
					...
					<!-- endSeparator -->
			  	    ...
			  	    <c:if test="${empty param['imprimer']}">
				  	    <div id="left_menu">		  	    	
				  	    	<jsp:include page="../../left_menu/left_menu_boutique.jsp" />
				  	    </div>
				  	</c:if>
			  	    <!-- fin left_menu -->
				    ...
				    <div id="<c:choose><c:when test="${empty param['imprimer']}">corps</c:when><c:otherwise>corpsPrint</c:otherwise></c:choose>">
			  	    	<jsp:include page="../../center/boutique/produit.jsp" />
			  	    </div>	
			  	    <!-- fin center -->
				</div>
				<!-- endContent -->
