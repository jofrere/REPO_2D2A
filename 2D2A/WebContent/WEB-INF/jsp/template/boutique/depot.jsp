...
<script src="/${ROOT}/resources/js/uploadfile/prototype.js"></script>
<script src="/${ROOT}/resources/js/uploadfile/scriptaculous.js"></script>
<script src="/${ROOT}/resources/js/uploadfile/multiupload.js"></script>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr">
	...
	<!-- Head -->
  	...
  	<body onload="init('/${ROOT}/resources/pic/panier/corbeille.gif', true);">
  		<div id="global">
			...
			<div id="space">
				...
				<div id="content">
					...
					<!-- left_menu -->
				  	<div id="left_menu">		  	    	
				  	   	<jsp:include page="../../left_menu/left_menu_service.jsp" />
				  	</div>	
				  	<!-- fin left_menu -->
					...
					<div id="corps">
				    	<c:choose>
				    		<c:when test="${empty FONCTIONAL}">
				    			<jsp:include page="../../center/boutique/depot.jsp" />
				    		</c:when> 
			  	    		<c:otherwise>
			  	    			TODO : Erreur monCompte depot
			  	    		</c:otherwise>
			  	    	</c:choose>
			  	    </div>	
			  	    <!-- fin center -->  	    
