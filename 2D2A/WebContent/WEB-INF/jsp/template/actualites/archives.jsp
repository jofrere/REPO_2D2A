			...
			<div id="space">
				...
				<div id="content">
					...
					<!-- endSeparator -->
			  	    ...
			  	    <!-- left_menu -->
			  	    <div id="left_menu">		  	    	
			  	    	<jsp:include page="../../left_menu/left_menu_archives.jsp" />
			  	    	<div id="calendrierAdd2">
							<div id="menuV" class="menuV">
								<div class="menuVSep"><br /></div>
								<ul class="menuVDeroulant">
									<li><a href="/${ROOT}/service/formulaireArchives.htm"><spring:message code="archives.addArchive"/></a></li>
								</ul>
							</div>
						</div>
			  	    </div>	
			  	    ...
			  	    <!-- start center -->
				    <div id="corps">
			  	    	<jsp:include page="../../center/actualites/archives.jsp" />
			  	    </div>	
			  	    <!-- fin center -->
				</div>
				<!-- endContent -->
