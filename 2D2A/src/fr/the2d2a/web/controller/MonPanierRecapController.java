...
public class MonPanierRecapController extends SimpleFormController {
	
	private static Logger logger = Logger.getLogger(MonPanierRecapController.class);
	...
	protected ModelAndView onSubmit(HttpServletRequest request,
		...
		logger.debug("In onSubmit de MonPanierRecapController");
