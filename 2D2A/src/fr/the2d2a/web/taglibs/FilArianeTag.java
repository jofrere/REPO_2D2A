...
public class FilArianeTag extends BodyTagSupport {
	...
	public int doStartTag() throws JspException {
		...
		if (current != null) {
			...
			//cas spécifiques (pas ds une boutique)
			...
			if (req.getRequestURI().endsWith("conditionsGenerales.jsp")) {
				mito.setNom("Conditions générales");
				rubriques.add(mito);
			}
			...
			if (req.getRequestURI().endsWith("calendrier.jsp")) {
				mito.setNom("Actualités - Calendrier");
				rubriques.add(mito);
			}
			if (req.getRequestURI().endsWith("presse.jsp")) {
				mito.setNom("Actualités - Coin Presse");
				rubriques.add(mito);
			}
			if (req.getRequestURI().endsWith("agenda.jsp")) {
				mito.setNom("Actualités - Agenda");
				rubriques.add(mito);
			}
			if (req.getRequestURI().endsWith("bibliotheque.jsp")) {
				mito.setNom("Actualités - Bibliothèque");
				rubriques.add(mito);
			}
			if (req.getRequestURI().endsWith("epot.jsp")) {
				mito.setNom("Services - Déposez vos objets");
				rubriques.add(mito);
			}
			...
			if (req.getRequestURI().endsWith("detailCommande.jsp")) {
				mito.setNom("Mon compte - Mes achats - Détail d'une commande");
				rubriques.add(mito);
			}
			if (req.getRequestURI().endsWith("erviceGeneral.jsp")) {
				mito.setNom("Services - Formulaire général");
				rubriques.add(mito);
			}
			...
			if (req.getRequestURI().endsWith("erviceEvenement.jsp")) {
				mito.setNom("Services - Formulaire évènement");
				rubriques.add(mito);
			}
			...
			if (req.getRequestURI().endsWith("recherche.jsp")) {
				mito.setNom("Services - Recherche avancée");
				rubriques.add(mito);
			}
			...
			if (req.getRequestURI().endsWith("infosLegales.jsp")) {
				mito.setNom("Informations - Infos Légales");
				rubriques.add(mito);
			}
