...
insert into PRODUIT_FR(proid, nom, information, description, materiaux, poids, hauteur, largeur, profondeur, diametre, desc_annee, signe_apparent, prixachat, dispo_loc ) values (1, "nom1", "information1", "desc1", "materiaux1", "poids1", "hauteur1", "largeur1", "profondeur1", "diametre1", "descAnnée1", "signe1", 245.0, 1);
insert into PRODUIT_EN(proid, nom, information, description, materiaux, poids, hauteur, largeur, profondeur, diametre, desc_annee, signe_apparent, prixachat, dispo_loc ) values (1, "nom1 EN", "information1 EN", "desc1", "materiaux1", "poids1", "hauteur1", "largeur1", "profondeur1", "diametre1", "descAnnée1", "signe1", 245.0, 1);

insert into PRODUIT(payid, desid, ediid, reference, visu_lang, quantite) values (1, 1, 1, "ref9876543210", 3, 10);
insert into PRODUIT_FR(proid, nom, information, description, materiaux, poids, hauteur, largeur, profondeur, diametre, desc_annee, signe_apparent, prixachat, dispo_loc ) values (2, "nom2", "information2", "desc2", "materiaux2", "poids2", "hauteur2", "largeur2", "profondeur2", "diametre2", "descAnnée2", "signe2", 150.95, 1);
insert into PRODUIT_EN(proid, nom, information, description, materiaux, poids, hauteur, largeur, profondeur, diametre, desc_annee, signe_apparent, prixachat, dispo_loc ) values (2, "nom2 EN", "information2 EN", "desc2", "materiaux2", "poids2", "hauteur2", "largeur2", "profondeur2", "diametre2", "descAnnée2", "signe2", 150.95, 1);
